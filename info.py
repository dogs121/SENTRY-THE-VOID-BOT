...
# PyroClient Setup 
API_ID = int(environ['27707164'])
API_HASH = environ['3d1ab21b51395b1d8297932e7a264e96']
BOT_TOKEN = environ['8062639950:AAGkfXLY8McNtg2kYVq0k2XvYG09iYlDIK0']
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7025034430').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1002337168965')
auth_grp = environ.get('-1004618461915')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://golucute985:ghYwYRbDe0ICu911@cluster0.deili.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
FILE_DB_URL = environ.get("FILE_DB_URL", https://t.me/+rVZKFxytYFBiZmI1)
FILE_DB_NAME = environ.get("FILE_DB_NAME", Database channel)
